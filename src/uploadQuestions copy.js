...
const questions = [
  {
    id: 1,
    type: "single",
    question: "Знайдіть значення виразу $\\sqrt{1\\frac{9}{16}}$",
    options: [
      { id: 1, label: "$\\frac{3}{4}$" },
  ...
  },
  {
    id: 2,
    type: "single",
    question: "Спростіть вираз $\\frac{x^4 - 16}{x^4 + 8x^2 + 16}$",
    options: [
  ...
  },
  {
    ...
    type: "single",
    question:
      "Якому проміжку належить найменший корінь рівняння $\\frac{3}{|x-1|} = 2$.",
    options: [
      { id: 1, label: "$(-\\infty;-2]$" },
      { id: 2, label: "$[-2;-1)$" },
      { id: 3, label: "$[-1;0)$" },
  ...
  },
  {
    ...
    type: "matching",
    question:
      "До кожного початку речення (1–3) добріть його закінчення (А–Д) так, щоб утворилося правильне твердження, якщо $ n > 0 $.",
    pairs: {
      left: [
  ...
  },
  {
    ...
    type: "input",
    question:
      "Готуючись до НМТ з математики, учню потрібно опанувати 11 тем з алгебри та 4 теми з геометрії. Для повторення на консультацію перед іспитом вчитель запропонував обрати дві теми з алгебри і одну тему з геометрії. Скільки всього є варіантів такого вибору?",
    answer: "220",
  },
  {
    id: 21,
    type: "input",
    question:
      "У прямокутній системі координат у просторі задано прямокутну призму $ABCA_1B_1C_1$, вершина основи $A$ якої співпадає з початком координат. Визначте площу повної поверхні цієї призми, якщо $B(4; 0; 0)$, $C(0; 3; 0)$, $A_1(0; 0; 5)$.",
    answer: "72",
  },
  {
    id: 22,
